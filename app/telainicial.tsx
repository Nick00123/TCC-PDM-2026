...
export default function App() {
 ...
 /* const confirmar = () => {
    Alert.alert('Bem-vindo!', `Olá ${nome}, seu cadastro foi concluído.`);
  ...
  return (
    ...
    />
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.label}>Como podemos te chamado:</Text>
        <TextInput
          style={styles.input}
        ...
        { /*{nome ? (
          <Text style={styles.preview}>Digitando: {nome}</Text>
        ) : null}*/ }
      </View>
